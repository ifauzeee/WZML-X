...
async def _mirror_leech(
    ...
    if file_:
        ...
        mime_type = file_.mime_type or get_mime_type(file_name)
    elif link and is_url(link):
    ...
    for key, (dest_id, category_name) in CUSTOM_DESTINATIONS.items():
