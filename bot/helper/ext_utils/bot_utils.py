...
async def set_commands(client):
    ...
    try:
        bot_cmds = [
            ...
            BotCommand(BotCommands.CancelAllCommand[0], "Cancel all Tasks in whole Bots."),
