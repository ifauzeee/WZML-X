...
class MirrorLeechListener:
    ...
    async def onDownloadComplete(self):
        multi_links = False
        # ... (sisa kode onDownloadComplete Anda di sini) ...
        # Fokus utama pada perubahan di bawah ini:
        
        self.name = (await aiopath.basename(dl_path)).replace('"',"")

        # ... (setelah blok if self.extract) ...
        if self.compress:
            # ...
